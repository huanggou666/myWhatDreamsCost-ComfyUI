    ...
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        if (nodeData.name === "LoadAudioUI") {
            ...
            nodeType.prototype.onNodeCreated = function () {
                ...
                // ====================================================================
                // Core preview updater — defined HERE so it captures audioEl/playerTitle
                // via closure. Called by both api listener and node.onExecuted.
                // ====================================================================
                const applyAudioPath = (rawPath) => {
                    ...
                    // If same file is re-executed, preserve the user's start/end selection.
                    if (isNewFile) {
                ...
                // Primary: api event listener (works even when node.onExecuted isn't called)
